 ...
 *
 * A simple print function to break the header dependency on printf. `stdio.h`
 * is very heavyweight, so break dependencies on it by wrapping `printf` and `vsnprintf`.
 */
