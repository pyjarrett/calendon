...
#define KN_MAX_BYTES_IN_GRAPHEME (KN_MAX_CODE_POINTS_IN_SEQUENCE * KN_MAX_UTF8_CODE_POINT_BYTE_LENGTH)
 ...
 */
typedef struct {
	// There is technically no limit on the number of code points which
	// may form a grapheme.  The approach here is to set a reasonable limit to
	// allow for development to continue.
