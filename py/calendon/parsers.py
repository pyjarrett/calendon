...
def parser_add_top_level_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    Adds properties `calendon_home` and `config`.
    """
    top_level = parser.add_argument_group('top-level')
    top_level.add_argument('--calendon-home',
                           type=str,
                           help="Root directory of the Calendon project, which will "
                                "override calendon_HOME")
